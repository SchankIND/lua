...
local function resetDragRace()
  ...
  for vehId, racer in pairs(dragData.racers) do
    ...
    --   spawn.safeTeleport(veh, dragData.strip.lanes[racer.lane].waypoints.spawn.transform.pos, dragData.strip.lanes[racer.lane].waypoints.spawn.transform.rot, nil, nil, nil, nil, racer.canBeReseted)
