...
local function getInfo()
  ...
  if res.os.type == 'linux' then
    ...
    if not Engine.Platform.isDesktopEntryInstalled() and not warningDisplayed.desktopEntry then
      local msg = "No desktop entry found. To get a BeamNG entry and (optionally) support for the " ..
        "beamng:// URL scheme, please run the script BinLinux/BeamNG_install_desktop_file.sh."
      log("W", "core_hwinfo", msg)
      warningDisplayed.desktopEntry = true
    end
  end
